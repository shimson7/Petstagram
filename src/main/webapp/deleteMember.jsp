...
<body>
	...
	<section class="contact-section">
		<div class="">
			<div class="col-12">
				<h2 class="contact-title">회원 탈퇴</h2>
			</div>
			<div class="">
				<form class="form-contact contact_form"
					action="deleteMember.do?memId=${member.memId}" method="post"
					id="updateForm" novalidate="novalidate">
					...
					<div class="form-group mt-3" style="margin-left: 15px;">
						<button type="submit" onclick="memberdelete();"
							class="button button-contactForm boxed-btn">회원탈퇴</button>
					</div>
				</form>
			</div>
		</div>
