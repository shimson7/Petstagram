...
<body>
	...
	<section class="contact-section">
		<div class="">
			<div class="col-12">
				<h2 class="contact-title">Petstagram 로그인</h2>
			</div>
			<div class="">
				<form class="form-contact contact_form" action="login.do"
					...
					<div style="margin-left: 15px;">
						<a href="signup.jsp" class="button button-contactForm boxed-btn">회원가입</a>
					</div>
				</form>
			</div>
		</div>
